...
function Msg({text,ok=false}:{text:string;ok?:boolean}){return <div className={"mt-6 rounded-xl border px-4 py-3 text-sm "+(ok?"border-green-400/20 bg-green-400/10 text-green-300":"border-red-400/20 bg-red-400/10 text-red-300")}>{text}    <MobileNav role={role} active="assignments" />
  </div>}